...
👉 **[Descargar mobile-ml.apk](mobile-ml.apk)** 👈

El APK está listo para instalar en tu dispositivo Android (requiere Android 7.0 Nougat o superior).

### Instalación Rápida:

1. Descarga el archivo `mobile-ml.apk` desde este repositorio
2. Habilita la instalación de aplicaciones de fuentes desconocidas en tu dispositivo
3. Abre el APK descargado y sigue las instrucciones de instalación
4. ¡Listo! Empieza a clasificar objetos con tu cámara 📸
